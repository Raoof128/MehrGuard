...
class KMPAnalyzer: ObservableObject {
    ...
    init() {
        ...
        #if DEBUG
        print("⚠️ [Mehr Guard] KMP common.framework NOT LINKED")
        print("⚠️ [Mehr Guard] Analysis will show error state")
        print("⚠️ [Mehr Guard] Run: ./gradlew :common:linkDebugFrameworkIosArm64")
        #endif
    }
